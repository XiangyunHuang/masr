...
```{r pde-1d, fig.cap="一维热传导方程的数值解热力图", fig.width=5.5, fig.height=5}
image(out,
...
```{r laplace-eq-image, fig.cap="解析解的二维图像", fig.width=5.5, fig.height=5}
image(z, col = terrain.colors(20))
contour(z, method = "flattest", add = TRUE, lty = 1)
```

```{r laplace-eq-persp, fig.cap="解析解的三维透视图像", fig.width=5.5, fig.height=5}
persp(z, 
  theta = 30, phi = 20, 
